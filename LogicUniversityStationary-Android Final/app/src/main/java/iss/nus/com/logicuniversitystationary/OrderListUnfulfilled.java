...
public class OrderListUnfulfilled extends AppCompatActivity implements AdapterView.OnItemClickListener, TabLayout.OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_list_unfulfilled);
        ...
        tablayout.addTab(tablayout.newTab().setText("New Orders"), false);
        tablayout.addTab(tablayout.newTab().setText("Unfulfilled"), true);

        lvOrderList= (ListView)findViewById(R.id.lvOrderList1);
        ...
        new AsyncTask<Void, Void, List<DepartmentOrder>>() {
            ...
            protected void onPostExecute(List<DepartmentOrder> result) {
                if (result.size() > 0) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OrderListUnfulfilled.this);

                    alertDialogBuilder
                            .setTitle("No unfulfilled orders at the moment")
                            .setCancelable(false)
...
//                                    OrderListUnfulfilled.this.onBackPressed();
//                                    OrderListUnfulfilled.this.finish();
                                }
                            });
    ...
    List<DepartmentOrder> getDepartmentOrders() {
        ...
        try {
            JSONArray jArray = JSONParser.getJSONArrayFromUrl(Globals.baseurl + "getUnfulfilled/"+Globals.EmpId);
